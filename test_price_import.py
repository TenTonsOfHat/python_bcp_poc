...
SELECT * FROM CurvePoint cp WHERE cp.EffectiveToDateTime > DATEADD(DAY, DATEDIFF(day, 0, (dateadd(day, datediff(day, 0, DATEADD(DAY, -5, GETDATE())),0))),0) AND cp.IsActive = 1
